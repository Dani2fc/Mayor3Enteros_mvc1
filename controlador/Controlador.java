    ...
    {   
        ...
        if(comando.equals("hallarMayor"))
        {
            ...
            this.venPrin.miPanelResultados.mostrarResultado(this.model.getMayor());
                ...
                JOptionPane.showMessageDialog(null, "Datos no compatibles. \n solo se aceptan numéros.", "Suma 3 enteros", JOptionPane.ERROR_MESSAGE);
            }
        ...
        {
            JOptionPane.showMessageDialog(null, "Los datos se borrarán", "Suma 3 enteros", JOptionPane.WARNING_MESSAGE);
